...
<div id="content">
    ...
    <div>
        ...
        <input id="btnCancel" type="button" value="отмениьть все загрузки" onclick="swfu.cancelQueue();" disabled="disabled" style="margin-left: 2px; font-size: 8pt; height: 29px;" />
    </div>
	</form>
</div>
</body>
