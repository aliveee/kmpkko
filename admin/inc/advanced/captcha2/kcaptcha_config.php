...
$foreground_color = isset($_GET["fc"]) ? html2rgb('#'.$_GET["fc"]) : array(mt_rand(0,80), mt_rand(0,80), mt_rand(0,80));
$background_color = isset($_GET["bc"]) ? html2rgb('#'.$_GET["bc"]) : array(mt_rand(220,255), mt_rand(220,255), mt_rand(220,255));
